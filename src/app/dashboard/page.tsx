      ...
      fetch(
        ...
        .then((data) => {
          ...
          setSelectedPositions((prevPositions) => [
            ...prevPositions,
            { position: e.latlng, placeName }, // Add new position with place name
          ]);
        })
        .catch((error) => {
